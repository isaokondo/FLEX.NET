Public Class frmHorPlanData
    Public Sub New()
        ...
        lblStartY.Text = HorPlan.起点Y座標.ToString("F3")
        lblStartDir.Text = HorPlan.起点方位角.ToString("F3")

        lblStartX.Text = HorPlan.発進X座標.ToString("F3")
        lblStartY.Text = HorPlan.発進Y座標.ToString("F3")

        lblReachX.Text = HorPlan.到達X座標.ToString("F3")
        lblReachY.Text = HorPlan.到達Y座標.ToString("F3")
        ...
        For ZoneNo As Integer = 0 To HorPlan.ゾーン総数 - 1
            ...
            dSet.setData(4, HorPlan.始点曲率半径(ZoneNo))
            dSet.setData(5, HorPlan.終点曲率半径(ZoneNo))
            dSet.setData(6, HorPlan.始点シフト量(ZoneNo))
            dSet.setData(7, HorPlan.終点シフト量(ZoneNo))
