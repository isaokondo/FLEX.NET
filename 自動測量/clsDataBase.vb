...
Public Class clsDataBase
    ...
    Public Sub New()
        '自動測量.INI より　HOST名、DB名　PORT番号を読込
        Dim IniFilePath As String =
           AppDomain.CurrentDomain.SetupInformation.ApplicationBase & "自動測量.INI"
        ...
        Else
            MsgBox($"自動測量.INIファイルが見つかりません。{vbCrLf}ファイルパス：{IniFilePath}",
        ...
        Try
            ...
            Dim Builder = New MySqlConnectionStringBuilder()
                ...
                MsgBox($"データベースSQLコマンドエラー{vbCrLf}
                    {ex.Message}{vbCrLf}{SQLCommand}{vbCrLf}　自動測量を終了します  ", vbCritical)
                Application.Exit()
...
Public Class clsDataSave
    ...
    Public Sub New()
        'コラム名のリストを取得
        Dim recFldData As DataTable = GetDtfmSQL("show columns from  自動測量データ ")
    ...
    Public Sub Save()
        ...
        ExecuteSqlCmd($"REPLACE INTO 自動測量データ VALUES({getSqlData()})")
        'recDataSave.Close()
    End Sub
    ...
    Private Function getSqlData() As String
        ...
        Try
            ...
            Data(ColumnList.IndexOf("対象")) = ExcelLink.Range("D2").Value



            Data(ColumnList.IndexOf("ﾀｰｹﾞｯﾄ数")) = ExcelLink.Range("D3").Value
            Data(ColumnList.IndexOf("鉛直角（°）")) = ExcelLink.Range("Z3").Value
            Data(ColumnList.IndexOf("鉛直角（′）")) = ExcelLink.Range("AA3").Value
            Data(ColumnList.IndexOf("鉛直角（″）")) = ExcelLink.Range("AB3").Value
            Data(ColumnList.IndexOf("水平角（°）")) = ExcelLink.Range("Z4").Value
            Data(ColumnList.IndexOf("水平角（′）")) = ExcelLink.Range("AA4").Value
            Data(ColumnList.IndexOf("水平角（″）")) = ExcelLink.Range("AB4").Value
            Data(ColumnList.IndexOf("水平距離(m)")) = ExcelLink.Range("Z5").Value
            Data(ColumnList.IndexOf("追尾ﾓｰﾄﾞ")) = ExcelLink.Range("AB5").Value
            Data(ColumnList.IndexOf("方位角(°)")) = ExcelLink.Range("Z6").Value
            Data(ColumnList.IndexOf("前胴ﾋﾟｯﾁﾝｸﾞ(°)")) = ExcelLink.Range("Z7").Value
            Data(ColumnList.IndexOf("後胴ﾋﾟｯﾁﾝｸﾞ(°)")) = ExcelLink.Range("G9").Value
            Data(ColumnList.IndexOf("後胴ﾛｰﾘﾝｸﾞ(°)")) = ExcelLink.Range("Z8").Value
            Data(ColumnList.IndexOf("方位角ｵﾌｾｯﾄ(°)")) = ExcelLink.Range("AB6").Value
            Data(ColumnList.IndexOf("ﾋﾟｯﾁﾝｸﾞｵﾌｾｯﾄ(°)")) = ExcelLink.Range("AB7").Value
            Data(ColumnList.IndexOf("ﾛｰﾘﾝｸﾞｵﾌｾｯﾄ(°)")) = ExcelLink.Range("AB8").Value
            Data(ColumnList.IndexOf("左右中折角(°)")) = ExcelLink.Range("F7").Value
            Data(ColumnList.IndexOf("上下中折角(°)")) = ExcelLink.Range("G7").Value
            Data(ColumnList.IndexOf("ﾀｰｹﾞｯﾄ1測点名")) = ExcelLink.Range("D14").Value
            Data(ColumnList.IndexOf("ﾀｰｹﾞｯﾄXm1(m)")) = ExcelLink.Range("E14").Value
            Data(ColumnList.IndexOf("ﾀｰｹﾞｯﾄYm1(m)")) = ExcelLink.Range("F14").Value
            Data(ColumnList.IndexOf("ﾀｰｹﾞｯﾄZm1(m)")) = ExcelLink.Range("G14").Value
            Data(ColumnList.IndexOf("ﾀｰｹﾞｯﾄ2測点名")) = ExcelLink.Range("D15").Value
            Data(ColumnList.IndexOf("ﾀｰｹﾞｯﾄXm2(m)")) = ExcelLink.Range("E15").Value
            Data(ColumnList.IndexOf("ﾀｰｹﾞｯﾄYm2(m)")) = ExcelLink.Range("F15").Value
            Data(ColumnList.IndexOf("ﾀｰｹﾞｯﾄZm2(m)")) = ExcelLink.Range("G15").Value
            Data(ColumnList.IndexOf("TS 測点名")) = ExcelLink.Range("D16").Value
            Data(ColumnList.IndexOf("Xts(m)")) = ExcelLink.Range("E16").Value
            Data(ColumnList.IndexOf("Yts(m)")) = ExcelLink.Range("F16").Value
            Data(ColumnList.IndexOf("Zts(m)")) = ExcelLink.Range("G16").Value
            Data(ColumnList.IndexOf("BS測点名")) = ExcelLink.Range("D17").Value
            Data(ColumnList.IndexOf("Xbs(m)")) = ExcelLink.Range("E17").Value
            Data(ColumnList.IndexOf("Ybs(m)")) = ExcelLink.Range("F17").Value
            Data(ColumnList.IndexOf("Zbs(m)")) = ExcelLink.Range("G17").Value
            Data(ColumnList.IndexOf("ﾀｰｹﾞｯﾄXt1(m)")) = ExcelLink.Range("E41").Value
            Data(ColumnList.IndexOf("ﾀｰｹﾞｯﾄYt1(m)")) = ExcelLink.Range("F41").Value
            Data(ColumnList.IndexOf("ﾀｰｹﾞｯﾄZt1(m)")) = ExcelLink.Range("G41").Value
            Data(ColumnList.IndexOf("平面偏差Dht1(㎜）")) = ExcelLink.Range("Y41").Value
            Data(ColumnList.IndexOf("縦断偏差Dvt1(㎜）")) = ExcelLink.Range("AI41").Value
            Data(ColumnList.IndexOf("ﾀｰｹﾞｯﾄXt2(m)")) = ExcelLink.Range("E42").Value
            Data(ColumnList.IndexOf("ﾀｰｹﾞｯﾄYt2(m)")) = ExcelLink.Range("F42").Value
            Data(ColumnList.IndexOf("ﾀｰｹﾞｯﾄZt2(m)")) = ExcelLink.Range("G42").Value
            Data(ColumnList.IndexOf("平面偏差Dht2(㎜）")) = ExcelLink.Range("Y42").Value
            Data(ColumnList.IndexOf("縦断偏差Dvt2(㎜）")) = ExcelLink.Range("AN42").Value
            Data(ColumnList.IndexOf("Px1(m)")) = ExcelLink.Range("E44").Value
            Data(ColumnList.IndexOf("Py1(m)")) = ExcelLink.Range("F44").Value
            Data(ColumnList.IndexOf("Pz1(m)")) = ExcelLink.Range("G44").Value
            Data(ColumnList.IndexOf("累積距離Lp1(m)")) = ExcelLink.Range("I44").Value
            Data(ColumnList.IndexOf("半径(m)Rp1")) = ExcelLink.Range("M44").Value
            Data(ColumnList.IndexOf("ｿﾞｰﾝ距離Lzp1(m)")) = ExcelLink.Range("N44").Value
            Data(ColumnList.IndexOf("平面偏差Dhp1(㎜）")) = ExcelLink.Range("Y44").Value
            Data(ColumnList.IndexOf("縦断偏差Dvp1(㎜）")) = ExcelLink.Range("AN44").Value
            Data(ColumnList.IndexOf("Px2(m)")) = ExcelLink.Range("E45").Value
            Data(ColumnList.IndexOf("Py2(m)")) = ExcelLink.Range("F45").Value
            Data(ColumnList.IndexOf("Pz2(m)")) = ExcelLink.Range("G45").Value
            Data(ColumnList.IndexOf("平面偏差Dhp2(㎜）")) = ExcelLink.Range("Y45").Value
            Data(ColumnList.IndexOf("縦断偏差Dvp2(㎜）")) = ExcelLink.Range("AN45").Value
            Data(ColumnList.IndexOf("Px3(m)")) = ExcelLink.Range("E46").Value
            Data(ColumnList.IndexOf("Py3(m)")) = ExcelLink.Range("F46").Value
            Data(ColumnList.IndexOf("Pz3(m)")) = ExcelLink.Range("G46").Value
            Data(ColumnList.IndexOf("平面偏差Dhp3(㎜）")) = ExcelLink.Range("Y46").Value
            Data(ColumnList.IndexOf("縦断偏差Dvp3(㎜）")) = ExcelLink.Range("AN46").Value
            Data(ColumnList.IndexOf("Px4(m)")) = ExcelLink.Range("E47").Value
            Data(ColumnList.IndexOf("Py4(m)")) = ExcelLink.Range("F47").Value
            Data(ColumnList.IndexOf("Pz4(m)")) = ExcelLink.Range("G47").Value
            Data(ColumnList.IndexOf("平面偏差Dhp4(㎜）")) = ExcelLink.Range("Y47").Value
            Data(ColumnList.IndexOf("縦断偏差Dvp4(㎜）")) = ExcelLink.Range("AN47").Value
            Data(ColumnList.IndexOf("平面平均偏差(mm)")) = ExcelLink.Range("S2").Value
            Data(ColumnList.IndexOf("縦断平均偏差(mm)")) = ExcelLink.Range("T2").Value
